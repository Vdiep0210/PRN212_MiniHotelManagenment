...
public partial class FUMiniHotelContext : DbContext
{
    public FUMiniHotelContext()
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=localhost;Database=MiniHotelManagement;User Id=sa;Password=V@ndiep0210;TrustServerCertificate=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Customer>(entity =>
        {
            ...
            entity.HasIndex(e => e.EmailAddress, "UQ__Customer__49A147405B7D80B4").IsUnique();

            entity.HasIndex(e => e.EmailAddress, "UQ__Customer__49A14740C82CD5AD").IsUnique();

            entity.HasIndex(e => e.EmailAddress, "UQ__Customer__49A14740FE31D465").IsUnique();
